...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SYMPTOM = 3,                    /* SYMPTOM  */
  YYSYMBOL_EXIT = 4,                       /* EXIT  */
  YYSYMBOL_YYACCEPT = 5,                   /* $accept  */
  YYSYMBOL_symptom_input = 6,              /* symptom_input  */
  YYSYMBOL_symptoms = 7                    /* symptoms  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "SYMPTOM", "EXIT",
  "$accept", "symptom_input", "symptoms", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* symptom_input: symptoms  */
#line 20 "symptom_medicine.y"
    {
...
#line 1114 "y.tab.c"
  ...
  case 3: /* symptoms: SYMPTOM  */
#line 27 "symptom_medicine.y"
    {
...
#line 1122 "y.tab.c"
  ...
  case 4: /* symptoms: symptoms SYMPTOM  */
#line 32 "symptom_medicine.y"
    {
        suggest_medicine(yytext);
    }
#line 1130 "y.tab.c"
  ...
  case 5: /* symptoms: EXIT  */
#line 37 "symptom_medicine.y"
    {
